...
export default function CharacterImageSwipper({ images }: Readonly<Props>) {
  if (!images || images.length === 0) {
    return <p className='text-gray-600 dark:text-gray-300 font-[--font-noto-sans-jp]'></p>
  }

  return (
    <div className='w-full max-w-[300px] animate-[fade-in_0.8s_ease-out]'>
      <Swiper modules={[Navigation, Pagination]} spaceBetween={10} slidesPerView={1} navigation className='rounded-lg'>
